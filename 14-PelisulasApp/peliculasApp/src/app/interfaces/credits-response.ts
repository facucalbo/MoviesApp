// To parse this data:
//
//   import { Convert, CreditsResponse } from "./file";
//
//   const creditsResponse = Convert.toCreditsResponse(json);
//
...
export class Convert {
    public static toCreditsResponse(json: string): CreditsResponse {
        return cast(JSON.parse(json), r("CreditsResponse"));
    }

    public static creditsResponseToJson(value: CreditsResponse): string {
        return JSON.stringify(uncast(value, r("CreditsResponse")), null, 2);
    }
}
